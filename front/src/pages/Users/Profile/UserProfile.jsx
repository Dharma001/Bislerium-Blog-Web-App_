...
function UserProfile() {
  ...
  return (
    ...
    <div className="bg-opacity-10 backdrop-blur-md rounded-xl border border-gray-200 p-6 max-w-xl w-full bg-slate-0">
      ...
      <p className="mt-2 text-pretty text-center text-gray-500">Change your profile details</p>
      <form  className="mt-6">
        ...
        <button className="mt-4 w-full px-5 py-3 text-white bg-orange-400 rounded hover:bg-orange-600 ">Update</button>
      </form>
      <hr></hr>
