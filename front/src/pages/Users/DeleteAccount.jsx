...
<p className="text-md font-black mb-4 text-red-500">Note:- By deleting your account, you will lose access to all your data and any associated services.</p>

<p className="text-lg font-bold">Please consider the following:</p>
<h3 className="text-lg my-4 space-y-2 list-disc list-inside">
  <div className='flex text-sm space-x-1'>
    <p className=''>1.</p>
    <p className="">Once deleted, your account information, including your profile, settings, and history, will be permanently removed from our system.</p>
  </div>
  <div className='flex text-sm space-x-1'>
    <p className=''>2.</p>
    <p className="text-sm">You will no longer be able to log in or access any features tied to your account.</p>
  </div>
  
  
</h3>

<p className="text-md mb-4">If you're certain about deleting your account, please click the <span className='text-red-600 font-black'>" Confirm Delete"</span>  button below.</p>

<p className="text-md font-black">Are you sure you want to delete your account?</p><br></br>
      ...
      {isOpen && (
        <div className="fixed z-50 inset-0 overflow-y-auto ">
          <div className="flex items-center justify-center min-h-screen bg-slate-100 opacity-100">
