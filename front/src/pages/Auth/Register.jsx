    ...
    <div>
      <div className="container mx-auto">
        <div className="flex items-center justify-center h-screen">
          <div className="flex flex-col gap-5 px-12 py-5 rounded border-2 bg-white w-[50%]">
            ...
            <form onSubmit={handleRegistration} className="">
              <div className="grid grid-cols-2 gap-2">
                ...
                <div className="relative bg-white rounded-md outline-none border ">
                <input
                  type="text"
                  name="firstName" 
              ...
              <div className="flex flex-col w-full">
                ...
                />
                <div className="absolute top-[.5rem] text-[1rem] left-2 z-10 pointer-events-none text-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" viewBox="0 0 256 256"><path fill="currentColor" d="M154.7 142.75a36 36 0 1 0-37.4 0a63.61 63.61 0 0 0-32.5 22.85a4 4 0 0 0 6.4 4.8a56 56 0 0 1 89.6 0a4 4 0 0 0 6.4-4.8a63.65 63.65 0 0 0-32.5-22.85M108 112a28 28 0 1 1 28 28a28 28 0 0 1-28-28m100-84H64a12 12 0 0 0-12 12v28H32a4 4 0 0 0 0 8h20v48H32a4 4 0 0 0 0 8h20v48H32a4 4 0 0 0 0 8h20v28a12 12 0 0 0 12 12h144a12 12 0 0 0 12-12V40a12 12 0 0 0-12-12m4 188a4 4 0 0 1-4 4H64a4 4 0 0 1-4-4V40a4 4 0 0 1 4-4h144a4 4 0 0 1 4 4Z"/></svg>
                 </div>
                {errors.address && (
              ...
              <button className="bg-[#F49f1c] p-3 mt-8 hover:bg-[#F49f1c]  text-white w-full">Register</button>
            </form>
            <hr></hr>
