        ...
        <div className="flex items-center justify-center">
          <div className="flex flex-col gap-3 px-[40px] w-full lg:w-[30%] border border-gray-300 py-[30px]">
            ...
            <div className="flex ml-[-5px]">
              ...
              <p className="mt-3 font-medium text-[1.1rem]">Wecome To Bislerium Blog</p>     
            </div>
            <div className="mt-[-8px] ml-2">
              <p className="font-medium text-[.9rem]"><span className="text-[#F49f1c] text-[1.1rem]">Note:Please put valid data</span></p>
            </div>  
            <form onSubmit={handleLogin} className="flex flex-col w-full">
              <div className="flex flex-col">
                ...
                {errors.email && (
                  <p className="text-[#F49f1c] text-sm">{errors.email}</p>
                )}
              </div>
              ...
              <div className="relative flex flex-col gap-2">
                ...
                {errors.password && (
                  <p className="text-[#F49f1c] text-sm">{errors.password}</p>
                )}
              </div>
              <button className="bg-[#F49f1c] p-3 mt-8 hover:bg-[#F49f1c]  text-white">Login</button>
            </form>
          </div>
        </div>
      </div>
