  ...
  return (
    <div className="container  mx-auto px-4 my-6">
      <div className="bg-white rounded-lg p-6">
        <h2 className="text-2xl text-start font-semibold text-gray-700 mb-6">
          Create Role
        </h2>
        <form  className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              autoFocus="on"
              className="w-full border focus:ring-2 focus:ring-green-700 border-gray-300 rounded-md outline-none p-2"
            />
          </div>
          <div>
            <label htmlFor="description" className="block mb-2">
