...
const Index = () => {
    ...
    return (
        <div className="mx-auto px-5 overflow-hidden h-[90dvh] my-6">
            
          <button className='text-white w-24 md:w-fit mr-6 md:mr-auto text-[9px] md:text-[14px] font-semibold px-4 py-2 rounded-md hover:bg-slate-800 border hover:border-slate-800 bg-slate-700 my-6'>
            {/* <Link to="/admin/createRole">Create</Link> */}
            Create
          </button>
                ...
                {roles.map((role, index) => (
                 ...
                 <tbody>
                  ...
                  <tr className= "bg-gray-50" >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">This is admin role</td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      {/* <Link to={`/admin/editRole/${role.id}`} className="text-white bg-blue-500 px-3 py-2 rounded-md hover:bg-blue-300 mr-2">
                        <i className="fa-regular fa-pen-to-square"></i>
                      </Link> */}
                      <div className="grid grid-cols-2 w-fit">
                      <div className="text-white text-center cursor-pointer bg-slate-700 px-3 py-2 rounded-md hover:bg-slate-800 mr-2">
                        <i className="">Edit</i>
                      </div>
                      <div className="text-white text-center cursor-pointer bg-red-700 px-3 py-2 rounded-md hover:bg-slate-800 mr-2">
