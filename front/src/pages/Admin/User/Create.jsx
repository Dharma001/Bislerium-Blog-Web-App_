...
//       <h2 className="text-xl text-gray-600 font-semibold my-6 ml-8 mb-8 text-start">Create User</h2>
...
//     required
//     className="border-2  h-12 focus:ring-2 outline-none focus:ring-orange-600 rounded-md px-4 py-2 w-full pl-12"
//     autoFocus="on"
//   />
...
//               // onChange={handleChange}
//               required
//               className="border-2 pl-12 h-12 focus:ring-2 outline-none focus:ring-orange-600 rounded-md px-4 py-2 w-full"
//             />
...
//                   // onChange={handleChange}
//                   className="border-2 pl-12  h-12 focus:ring-2 rounded-md outline-none focus:ring-orange-600 px-4 py-2 "
//                   autoComplete="off"
...
//             />
            ...
            // <button
            //   type="button"
            //   className="absolute top-12 transform -tranorange-y-1/2 right-2"
    ...
    <>
      <div className="px-4">
        <div className="px-5">
          ...
          <hr className="border-2-black" />
          <form onSubmit={handleSubmit} className="space-y-4 mt-8 h-[80dvh]">
